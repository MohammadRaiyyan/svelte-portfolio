...
{#if $showArrow}
	<button
		...
		class="fixed bottom-5 left-1/2 -translate-x-1/2 text-gray-700 bg-white/70 backdrop-blur-md p-3 rounded-full shadow-lg hover:scale-110 transition transform animate-bounce"
